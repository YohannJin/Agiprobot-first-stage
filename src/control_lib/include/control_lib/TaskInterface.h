...
public:
    ...
    TaskInterface(int argc, char** argv)
    {
        Robot_Task = new RobotControl(argc, argv);
        Drill_Task = new DrillControl(argc, argv);
    }
    ~TaskInterface()
    {
        delete Drill_Task;
    ...
    void setGeneralVariables(double radiusSearchfield, double strengthMax, double strengthMin, double velocity, double abortAtDepth)
    {
